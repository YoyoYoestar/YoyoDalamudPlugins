# copied from https://github.com/Aireil/MyDalamudPlugins/blob/master/generate_pluginmaster.py
...
DOWNLOAD_URL = 'https://github.com/anomek/MyDalamudPlugins/raw/{branch}/plugins/{plugin_name}/latest.zip'
